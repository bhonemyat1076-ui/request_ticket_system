<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="text-sm text-gray-600 mt-6 text-center border-t pt-4">
            {{ __("Don't have an account?") }} 
            <a href="{{ route('register') }}" class="font-bold text-red-600 hover:text-red-700 underline underline-offset-4">
                {{ __('Register here') }}
            </a>
        </div>
    </form>
