                                ...
                                <tr class="hover:bg-yellow-50/30 transition-colors">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="h-9 w-9 rounded-full bg-yellow-600 flex items-center justify-center text-white font-black text-sm shadow-sm">
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <a href="{{ route('admin.tickets.show', $ticket) }}" 
                                           class="inline-flex items-center px-3 py-1.5 bg-white border border-yellow-600 text-yellow-600 text-xs font-bold rounded-md hover:bg-yellow-600 hover:text-white transition shadow-sm">
                                            Manage
                                        </a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center">
                                        <div class="text-gray-400 italic">No pending tickets found.</div>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
