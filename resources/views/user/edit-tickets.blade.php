<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-8">
                    <form method="POST" action="{{ route('user.update-tickets', $tickets->id) }}" enctype="multipart/form-data">
                        @csrf

                        <div class="mb-6">
                            <x-input-label for="title" :value="__('Ticket Subject')" />
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title" value="{{ $tickets->title }}" required />
                        ...
                        <div class="mb-6">
                            ...
                            <select name="priority" id="priority" class="block mt-1 w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm">
                                ...
                                <option value="medium" {{ $tickets->priority == 'medium' ? 'selected' : '' }}>Medium</option>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="5" class="block mt-1 w-full border-gray-300 focus:border-red-500 focus:ring-red-500 rounded-md shadow-sm" required>{{ $tickets->description }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Max size: 2MB. Leave empty to keep current attachment.</p>
